...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2024 at 01:12 AM
...
CREATE TABLE `dances` (
  ...
  `dance_english_name` varchar(500) NOT NULL,
  `dance_alternate_name` varchar(500) NOT NULL,
  `dance_telugu_name` varchar(500) NOT NULL,
  `dance_category` varchar(255) DEFAULT NULL,
  `dance_origin` varchar(255) DEFAULT NULL,
  `dance_description` varchar(5000) DEFAULT NULL,
  `dance_image_reference` text DEFAULT NULL,
  `dance_video_reference` text DEFAULT NULL,
  `dance_key_words` varchar(255) DEFAULT NULL,
  `dance_status` varchar(255) DEFAULT NULL,
  `artist_images` text NOT NULL,
  `links` text NOT NULL,
  `malayalam_name` varchar(60) DEFAULT NULL,
  `hindi_name` varchar(60) DEFAULT NULL,
  `odish_name` varchar(60) DEFAULT NULL,
  `bengal_name` varchar(60) DEFAULT NULL,
  `native_disp_language` varchar(255) NOT NULL DEFAULT 'telugu'
...
(172, 'dance 123', '', '123', 'Folk', '', '', '', '', '', 'Done', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(173, '', '', '', NULL, '', '', '', NULL, '', 'Draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(174, 'Bboy', '', '', NULL, 'usa', 'test123', 'test123', NULL, 'test123', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(175, 'hiphop ', '', '', NULL, 'test123', '12312312312312321', '1231231231232', NULL, 'test123', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(176, 'hiphop ', '', '', NULL, 'test123', '12312312312312321', '1231231231232', NULL, 'test123', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(177, 'hiphop123', '', '', NULL, 'usa', 'test123', 'test123', NULL, 'mn', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(178, 'hiphop123', '', '', NULL, 'usa', 'test123', 'test123', NULL, 'mn', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(179, 'hiphop ', '', '', NULL, 'test123', '12312312312312321', '1231231231232', NULL, 'test123', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(182, 'morden dance', '', '', 'Folk', 'USA', 'hello', '', '', 'MN', 'Submitted', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(183, 'asdasdas', '', '', NULL, 'asdasd', 'sdasda', 'sdas', NULL, 'asda', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(184, '123123', '', '', NULL, '123123', '123123123', '123123213', NULL, '12312312', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(185, 'no way home', '', '', NULL, 'usa', '12312', '312312', NULL, 'test1 ', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu'),
(186, 'dance 123', '', '', NULL, 'USA', 'test 123', 'test123', NULL, 'test 123', 'draft', '', '', NULL, NULL, NULL, NULL, 'telugu');
...
(7, 'draytht', '80c883fd80ce9c8f80e5cdf0b338775e8007b669');
...
CREATE TABLE `word_list` (
  ...
  `hindi_word` varchar(255) NOT NULL,
  `kannada_word` varchar(255) NOT NULL,
  `malayalam_word` varchar(255) NOT NULL,
  `gujarathi_word` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `dances`
  MODIFY `dance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
